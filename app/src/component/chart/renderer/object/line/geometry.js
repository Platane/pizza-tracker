...
const circle = Array.from({ length: LINE_SEGMENT })
    .map( (_,k,arr) =>
        vec2.set(
            vec2.create(),
...
export const computeLine = ( line: Array<Vec2> ) : { vertices: Array<number>, faces: Array<number>, normals: Array<number> } => {
